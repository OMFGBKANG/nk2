...
#ifndef SANDGATE2G
	union iwreq_data wrqu;
//	char extra[IW_CUSTOM_MAX + 1];		//modify warnning message.

		memset(&wrqu, 0, sizeof(wrqu));
//		memset(extra, 0, sizeof(extra));	//modify warnning message.
//		wireless_send_event(iscan->dev, SIOCGIWSCAN, &wrqu, extra);	//modify warnning message.
